...
**The Blog Ruby on Rails App** is my first attempt at  full stack application, it an individual project at Microverse.
...
```sh
  git git clone git@github.com:kkolade/rails_blog_app.git
  cd blog
```
--->
...
Install the gems required for this project with:
